package vn.vinfast.vfqc.api.interfaces.dto.ai.response;
...
public record AiConfigResponse(
    @Schema(description = "Public ID of the AI config")
    UUID publicId,
    ...
    @Schema(description = "Key source: PLATFORM or PERSONAL")
    KeySource keySource,

    @Schema(description = "Indicates if an API key is currently saved")
    boolean hasApiKey,

    @Schema(description = "Model for evaluation/judging")
    String evaluationModel,

    @Schema(description = "Model for AI generation")
