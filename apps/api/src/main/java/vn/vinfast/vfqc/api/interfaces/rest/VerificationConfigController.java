...
import vn.vinfast.vfqc.api.application.verification.VerificationConfigService;
...
import vn.vinfast.vfqc.api.interfaces.dto.verification.response.OperatorCatalogResponse;
...
public class VerificationConfigController {
  ...
  @Operation(summary = "Get Verification Config", description = "Retrieves the verification configuration for a project.")
  ...
  @Operation(summary = "Save Verification Config", description = "Saves or updates the verification configuration.")
  @PutMapping("/projects/{publicId}/config/verification")
  public VerificationConfigResponse save(
      @PathVariable UUID publicId,
      @Valid @RequestBody SaveVerificationRequest request) {
