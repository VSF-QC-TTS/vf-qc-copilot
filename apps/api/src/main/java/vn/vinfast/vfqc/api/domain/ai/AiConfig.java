...
/**
 * Aggregate root for AI configuration per project.
 * Supports both evaluation (judging) and generation (test case creation) models.
 *
...
public class AiConfig {
  ...
  /**
   * Resolves the model string to use for a given AI use case.
   * Falls back to evaluationModel if generationModel is not configured.
   */
