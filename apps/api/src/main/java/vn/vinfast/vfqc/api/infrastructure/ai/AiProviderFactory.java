...
/**
 * Factory that resolves the correct AI provider adapter based on provider type.
 * Uses Spring auto-discovery of all AiProviderPort implementations.
 *
...
public class AiProviderFactory {
  ...
  public AiProviderPort getAdapter(AiProvider provider) {
    ...
    if (adapter == null) {
      throw ResourceException.of(ErrorCode.UNSUPPORTED_AI_PROVIDER, "Provider " + provider + " is not supported yet.");
    }
    return adapter;
  }
}
