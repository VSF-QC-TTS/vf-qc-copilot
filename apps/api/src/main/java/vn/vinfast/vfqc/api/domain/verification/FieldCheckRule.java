...
/**
 * A field-level verification rule that checks a specific response path
 * against an expected value or dataset column.
 * Uses expectedColumnKey (UUID) for stable column reference that survives renames.
 *
