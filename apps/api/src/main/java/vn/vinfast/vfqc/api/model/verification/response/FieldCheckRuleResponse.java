...
public record FieldCheckRuleResponse(
    ...
    @Schema(description = "Response path") String responsePath,
    @Schema(description = "Operator") CheckOperator operator,
    @Schema(description = "Expected source") ExpectedSource expectedSource,
    @Schema(description = "Stable UUID of the dataset column") UUID expectedColumnKey,
    @Schema(description = "Expected value") String expectedValue,
