...
@RestController
@RequestMapping(
    value = "/api/v1/projects/{publicId}/config/ai",
...
public class AiConfigController {
  ...
  public AiConfigResponse save(
      @PathVariable UUID publicId, @Valid @RequestBody SaveAiConfigRequest req) {
    return aiConfigService.save(publicId, req);
  }

  @Operation(
      summary = "Get AI Config",
      description = "Gets the AI configuration. Secrets are masked.")
  @GetMapping
  ...
  public AiExecutionResult test(
      @PathVariable UUID publicId, @Valid @RequestBody TestAiConfigRequest req) {
